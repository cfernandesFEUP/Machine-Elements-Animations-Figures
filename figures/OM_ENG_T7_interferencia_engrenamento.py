...
dm.dimt(T1[0],T1[1],r'$\mathrm{T_1}$','right','top')
...
plt.savefig('pdf/engrenamentoInt.pdf', bbox_inches = 'tight',
    pad_inches = 0, transparent=True)
###############################################################################
...
plt.savefig('pdf/engrenamentoAbInt.pdf', bbox_inches = 'tight',
    pad_inches = 0, transparent=True)
###############################################################################
...
plt.savefig('pdf/engrenamentoAInt.pdf', bbox_inches = 'tight',
    pad_inches = 0, transparent=True)
# ###############################################################################
...
# plt.savefig('pdf/engrenamentoBInt.pdf', bbox_inches = 'tight',
#     pad_inches = 0, transparent=True)
# ###############################################################################
...
# plt.savefig('pdf/engrenamentoBbInt.pdf', bbox_inches = 'tight',
#     pad_inches = 0, transparent=True)
# ###############################################################################
...
# dm.dimtarray(dm.cxy(ra1, O1[0], O1[1], angA),r'$\mathrm{A}$','right','top')
# dm.dimtarray(dm.cxy(ra2, O2[0], O2[1], angB),r'$\mathrm{B}$','left','bottom')
# plt.savefig('pdf/engrenamentoCInt.pdf', bbox_inches = 'tight',
#     pad_inches = 0, transparent=True)
# ###############################################################################
# ## ENGRENAMENTO COM ra1 > pb ##################################################
# ###############################################################################
...
# dm.dimtarray(dm.cxy(ra2, O2[0], O2[1], angB),r'$\mathrm{B}$','left','bottom')
# plt.savefig('pdf/engrenamentoDInt.pdf', bbox_inches = 'tight',
#     pad_inches = 0, transparent=True)
# ###############################################################################
# ## RAZÃO DE CONDUÇÃO  #########################################################
# ###############################################################################
...
# dm.dimtarray(dm.cxy(ra1, O1[0], O1[1], angA),r'$\mathrm{A}$','right','top')
# dm.dimtarray(dm.cxy(ra2, O2[0], O2[1], angB),r'$\mathrm{B}$','left','bottom')
# plt.savefig('pdf/conducaoSInt.pdf', bbox_inches = 'tight',
#     pad_inches = 0, transparent=True)
# ###############################################################################
# ## TP1  #######################################################################
# ###############################################################################
...
# plt.savefig('pdf/TP1_primitivosInt.pdf', bbox_inches = 'tight',
#     pad_inches = 0, transparent=True)
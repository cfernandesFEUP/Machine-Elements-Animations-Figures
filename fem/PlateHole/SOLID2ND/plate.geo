...
// TRANSFINITE LINES
Transfinite Curve {1,2,3,4} = ni Using Progression delta;
Transfinite Curve {5,6,7,8,9,10,11,12,14,17,20,23} = ni Using Progression 1;
...
Recombine Surface {1,2,3,4,11,12,13,14,15,16,17,18};

// PHYSICAL ENTITIES
Physical Line("fix") = {16,17,18};
Physical Line("load") = {22,23,24};
Physical Line("hole") = {5,6,7,8};
Physical Surface('plate') = {1,2,3,4,5,11,12,13,14,15,16,17,18};
